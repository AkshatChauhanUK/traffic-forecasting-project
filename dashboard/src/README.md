...
Three model families trained and evaluated per junction, using a strict **time-based train/test split** (never random — shuffling time series leaks the future into the past):
